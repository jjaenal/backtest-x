...
class TemplatePickerSheetModel extends BaseViewModel {
  ...
  String get selectedTemplateQuery => _strategyBuilderViewModel?.selectedTemplateQuery ?? '';
  Set<String> get selectedTemplateCategories => _strategyBuilderViewModel?.selectedTemplateCategories.toSet() ?? {};
  List<String> get recentTemplateKeys => _strategyBuilderViewModel?.recentTemplateKeys ?? [];
  ...
  void applyTemplate(String templateKey) {
    ...
    _bottomSheetService.completeSheet(SheetResponse(confirmed: true, data: templateKey));
  }
