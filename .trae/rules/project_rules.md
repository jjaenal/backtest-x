...
- Jangan commit API keys atau URL ke repository.
- Gunakan environment variables dan `--dart-define` untuk development.

Contoh (development):

```bash
flutter run \
  --dart-define=SUPABASE_URL=https://tpgvvhhrugzgbjyujdsa.supabase.co \
  --dart-define=SUPABASE_ANON_KEY=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InRwZ3Z2aGhydWd6Z2JqeXVqZHNhIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjA1MjQ4NDgsImV4cCI6MjA3NjEwMDg0OH0.0Vfe6Vvu-1ExbQY-k-qLUT8qFLLo0kZ9dkTOqqMcpPk
```

Atau gunakan file `.env` (tidak di-commit) yang kemudian di-injeksi via tooling/Makefile.
